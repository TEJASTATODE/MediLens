...
const Profile = () => {
  ...
  const deleteRecord = async (id) => {
    if (!window.confirm("Archiving: Confirm removal of this clinical record?"))
      return;
    try {
  ...
  const avatarUrl =
    ...
    `https://api.dicebear.com/7.x/initials/svg?seed=${
      user.username || "U"
    }&backgroundColor=0066FF&textColor=ffffff`;
          ...
          >
            ...
            <div className="relative group z-10">
              ...
              <img
                src={avatarUrl}
                alt="User"
                className="relative w-32 h-32 md:w-40 md:h-40 rounded-[48px] object-cover border-4 border-white shadow-2xl bg-slate-50 transition-transform duration-500 group-hover:scale-[1.02]"
              />
            ...
            <div className="flex-1 text-center md:text-left space-y-6 z-10">
              ...
              <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                <button
                  ...
                  className="bg-slate-900 text-white px-8 py-4 rounded-[22px] font-black uppercase tracking-widest text-[11px] flex items-center gap-3 hover:bg-blue-600 transition-all shadow-xl shadow-slate-200"
                >
                ...
                <button
                  ...
                  className="bg-white text-rose-600 border border-rose-100 px-8 py-4 rounded-[22px] font-black uppercase tracking-widest text-[11px] flex items-center gap-3 hover:bg-rose-50 transition-all"
                >
          ...
          >
            <div className="relative z-10">
              <div className="flex justify-between items-start">
                ...
                <Activity
                  className="text-blue-300 opacity-50 group-hover:opacity-100 transition-opacity"
                  size={20}
                />
              </div>
              <h3 className="text-blue-100 font-bold uppercase tracking-[0.2em] text-[10px] mt-6">
                Medicinal Records
              </h3>
              <p className="text-6xl font-black mt-2 leading-none">
                {history.length}
              </p>
            </div>
            <div className="relative z-10 mt-6 pt-6 border-t border-white/10">
              <p className="text-[10px] font-medium text-blue-100/80 leading-relaxed uppercase tracking-wider">
                Verified via Med-AI Engine
              </p>
            </div>
            ...
            {loading ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[1, 2, 3].map((n) => (
                  <div
                    key={n}
                    className="h-[400px] bg-white rounded-[44px] animate-pulse border border-slate-100"
                  />
                ))}
              </div>
                  ...
                  >
                    <div className="relative h-56 rounded-[32px] overflow-hidden mb-6 shadow-inner bg-slate-50">
                      ...
                      <button
                        ...
                        className="absolute top-4 right-4 p-2.5 bg-white/20 backdrop-blur-md border border-white/30 text-white hover:bg-rose-500 hover:text-white rounded-2xl transition-all"
                      >
                        <Trash2 size={16} />
                      </button>
                    </div>
                    ...
                    <div className="px-4 flex-1 flex flex-col relative z-10">
                      ...
                      <p className="text-slate-500 text-sm leading-relaxed font-medium line-clamp-2 mb-6 h-10">
                        {scan.usage ||
                          "Clinical records verified. Awaiting further indexing for usage details."}
                      </p>
              ...
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="text-center py-32 bg-white rounded-[48px] border-2 border-dashed border-slate-200 flex flex-col items-center"
              >
                <LayoutGrid className="text-slate-200 mb-4" size={48} />
                <h3 className="text-2xl font-black text-slate-900">
                  No records found
                </h3>
                <p className="text-slate-500 mt-2 font-medium mb-8">
                  Try adjusting your filters or performing a fresh scan.
                </p>
                <button
                  onClick={() => {
                    setSearchQuery("");
                  ...
                  className="text-blue-600 font-black uppercase tracking-widest text-[11px] hover:underline"
                >
                  Clear all filters
                </button>
              </motion.div>
        ...
        {selectedScan && (
          <div className="fixed inset-0 flex items-center justify-center p-4 z-[110]">
            ...
            <motion.div
              ...
              className="bg-white rounded-[48px] w-full max-w-2xl max-h-[85vh] overflow-hidden relative z-10 shadow-3xl border border-slate-100 flex flex-col"
            >
              <div className="p-8 pb-4 flex justify-between items-start bg-white z-20 sticky top-0">
                <div>
                  <div className="flex items-center gap-3 mb-1">
                    <span className="bg-blue-100 text-blue-700 text-[9px] font-black uppercase tracking-widest px-3 py-1 rounded-full">
                      Clinical Analysis
                    </span>
                    <span className="text-slate-400 text-[10px] font-bold uppercase tracking-widest">
                      Record #{selectedScan._id.slice(-8)}
                    </span>
                  </div>
              ...
              <div className="overflow-y-auto p-8 pt-4 space-y-8 scrollbar-hide">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="p-6 bg-slate-50 rounded-[32px] border border-slate-100 flex flex-col justify-center">
                    ...
                    <p className="text-lg font-bold text-slate-800">
                      {selectedScan.manufacturer || "Certified Producer"}
                    </p>
                  </div>
                </div>
                    ...
                    <div className="flex gap-6 items-start p-6 rounded-[32px] bg-indigo-50/50 border border-indigo-100/50">
                      ...
                      <div>
                        <h4 className="text-lg font-black text-slate-900 mb-3 tracking-tight">
                          Bio-Equivalent Medicine
                        </h4>
                        <div className="flex flex-wrap gap-2">
                          {selectedScan.alternatives.map((alt, i) => (
                            <span
                              key={i}
                              className="bg-white border border-indigo-100 text-slate-700 text-[10px] font-bold px-4 py-2 rounded-xl shadow-sm uppercase"
                            >
                              {alt}
                            </span>
                          ))}
        ...
        {isEditing && (
          <div className="fixed inset-0 flex items-center justify-center p-4 z-[100]">
            ...
            <motion.div
              ...
              className="bg-white p-10 rounded-[44px] w-full max-w-sm relative z-10 shadow-3xl border border-slate-100"
            >
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl py-4 pl-12 pr-4 text-slate-900 focus:border-blue-500 outline-none transition-all font-bold"
                    />
                  </div>
                </div>
                <button
                  type="submit"
                  className="w-full py-5 bg-slate-900 text-white rounded-[22px] font-black uppercase tracking-widest text-[11px] hover:bg-blue-600 transition-all flex items-center justify-center gap-3 shadow-xl shadow-slate-200"
                >
